...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'emossip', 'email': 'emossip@terpmail.umd.edu', 'first_name': 'Ethan', 'last_name': 'Mossip',
         'password': generate_password_hash('emossip', method='pbkdf2:sha256'), 'role': 'STUDENT'},
    ]
